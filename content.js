...
for (let i = 0; i < productCards.length; i++) {
    ...
    productCards[i].appendChild(text);

    const pret = document.createElement("p"); 
    pret.setAttribute("class","price");
    pret.innerText = product.Pret;
    productCards[i].appendChild(pret);
}